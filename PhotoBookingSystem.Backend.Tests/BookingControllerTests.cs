...
namespace photo_booking_system.Backend.Tests
{
    public class BookingControllerTests
    {
        ...
        private BookingCreationDto testCreationDto =  new BookingCreationDto() { ClientName = "test1", ClientEmail = "test@test.test", ClientPhone = "123-456-7890", StartDateTime = System.DateTime.Now, Address = "123 Fake Street", Comments = "blah", Photo = 30, Video = 0, Price = 100, Paid = 0};
        private BookingUpdateDto testUpdateDto = new BookingUpdateDto() { ClientName = "test1", ClientEmail = "test@test.test", ClientPhone = "123-456-7890", StartDateTime = System.DateTime.Now, Address = "123 Fake Street", Comments = "blah", Photo = 30, Video = 0, Price = 100, Paid = 0 };
